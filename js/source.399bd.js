...
var _stylesM = _interopRequireDefault(__webpack_require__(35));

var _task = _interopRequireDefault(__webpack_require__(9));

var _Checkbox = _interopRequireDefault(__webpack_require__(10));

var _TaskInput = _interopRequireDefault(__webpack_require__(42));

var _Star = _interopRequireDefault(__webpack_require__(43));

var _Edit = _interopRequireDefault(__webpack_require__(44));

var _Remove = _interopRequireDefault(__webpack_require__(45));
...
class Task extends _react.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "_setEditingState", state => {
    ...
    _defineProperty(this, "_handleEditClick", () => {
      this._setEditingState();
    });

    _defineProperty(this, "_handleRemoveClick", () => {
      const {
        id
      } = this.props;
    ...
    _defineProperty(this, "_handleFavoriteChange", () => {
      const {
        id
      } = this.props;
      this.props.favorite ? this.props.markAsNotFavorite(id) : this.props.markAsFavorite(id);
    });

    _defineProperty(this, "_handleCompleteChange", () => {
      const {
        id
      } = this.props;
      this.props.completed ? this.props.markAsUnCompleted(id) : this.props.markAsCompleted(id);
    });

    _defineProperty(this, "_editMessage", message => {
  ...
  render() {
    ...
    return _react.default.createElement("li", {
      ...
      color1: "#3b8ef3",
      color2: "#fff"
    })), _react.default.createElement(_TaskInput.default, {
...
Task.propTypes = _objectSpread({}, _task.default, {
  markAsNotFavorite: _propTypes.default.func.isRequired,
  markAsFavorite: _propTypes.default.func.isRequired,
  markAsUnCompleted: _propTypes.default.func.isRequired,
  markAsCompleted: _propTypes.default.func.isRequired
});
...
var _App = _interopRequireDefault(__webpack_require__(30));
...
*/
var aa=__webpack_require__(4),ba=__webpack_require__(0),m=__webpack_require__(22),p=__webpack_require__(3),v=__webpack_require__(6),da=__webpack_require__(23),ea=__webpack_require__(24),fa=__webpack_require__(25),ha=__webpack_require__(5);
...
var _Task = _interopRequireDefault(__webpack_require__(8));

var _Scheduler = _interopRequireDefault(__webpack_require__(46));
...
class TaskInput extends _react.default.Component {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "_handleChange", event => {
      this.setState({
        message: event.target.value
      });
    });

    _defineProperty(this, "_handleFocus", event => {
      const {
        value
      } = event.target;
      event.target.value = "";
...
TaskInput.propTypes = {
  ...
  setEditingState: _propTypes.default.func.isRequired,
  editMessage: _propTypes.default.func.isRequired
};
...
var _stylesM = _interopRequireDefault(__webpack_require__(16));

var _REST = __webpack_require__(48);

var _instruments = __webpack_require__(11);

var _Header = _interopRequireDefault(__webpack_require__(50));

var _TasksList = _interopRequireDefault(__webpack_require__(51));

var _TaskCreator = _interopRequireDefault(__webpack_require__(52));

var _Footer = _interopRequireDefault(__webpack_require__(53));

var _Spinner = _interopRequireDefault(__webpack_require__(54));
...
class Scheduler extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_updateAfterApiCall", tasks => {
      this.setState({
        tasks,
        fetching: false
      });
    ...
    _defineProperty(this, "_addTask", (message = "") => {
      if (!message.length) {
        return;
      }
      ...
      _REST.api.createTask(message).then(task => this._updateAfterApiCall([task, ...tasks]));
    });

    _defineProperty(this, "_modifyTask", (id, field, value) => {
      ...
      _REST.api.updateTask(_objectSpread({}, task, {
        [field]: value
      })).then(([updatedTask]) => this._updateAfterApiCall(this.state.tasks.map(task => task.id === id ? updatedTask : task)));
    });

    _defineProperty(this, "_editTaskMessage", (id, message = "") => {
      if (!message.length) {
        return;
      }
    ...
    _defineProperty(this, "_markAsCompleted", id => {
      this._modifyTask(id, "completed", true);
    });

    _defineProperty(this, "_markAsFavorite", id => {
      this._modifyTask(id, "favorite", true);
    });

    _defineProperty(this, "_markAsUnCompleted", id => {
      this._modifyTask(id, "completed", false);
    });

    _defineProperty(this, "_markAsNotFavorite", id => {
    ...
    _defineProperty(this, "_removeTask", id => {
      ...
      _REST.api.removeTask(id).then(() => {
        this._updateAfterApiCall([...tasks.filter(task => task.id !== id)]);
      });
    });

    _defineProperty(this, "_markAllTasksAsCompleted", () => {
      this.setState({
        fetching: true
      });

      _REST.api.completeAllTasks(this.state.tasks.map(task => _objectSpread({}, task, {
        ["completed"]: true
      }))).then(tasks => this._updateAfterApiCall(tasks));
    });

    _defineProperty(this, "_isAllTasksCompleted", () => !this.state.tasks.find(task => !task.completed));
    ...
    _defineProperty(this, "_filterTasks", () => {
      ...
      return (0, _instruments.sortTasksByGroup)(filterValue.length ? tasks.filter(task => task.message.includes(filterValue)) : tasks);
    });

    _defineProperty(this, "_setFilterValue", value => {
      this.setState({
        filterValue: value
      });
    });
  ...
  componentDidMount() {
    ...
    _REST.api.fetchTasks().then(tasks => this._updateAfterApiCall(tasks));
  }

  render() {
    return _react.default.createElement("section", {
      className: _stylesM.default.scheduler
    }, _react.default.createElement("main", null, this.state.fetching ? _react.default.createElement(_Spinner.default, null) : null, _react.default.createElement(_Header.default, {
    ...
    }), _react.default.createElement(_TasksList.default, {
...
const api = {
  fetchTasks: () => fetch(_config.MAIN_URL, _objectSpread({}, requestHeaders, {
    method: "GET"
  })).then(response => response.json()).then(response => response.data),
  createTask: message => fetch(_config.MAIN_URL, _objectSpread({}, requestHeaders, {
    method: "POST",
    body: JSON.stringify({
      message
    })
  })).then(response => response.json()).then(response => response.data),
  updateTask: task => fetch(_config.MAIN_URL, _objectSpread({}, requestHeaders, {
    method: "PUT",
    body: JSON.stringify([task])
  })).then(response => response.json()).then(response => response.data),
  removeTask: id => fetch(`${_config.MAIN_URL}/${id}`, _objectSpread({}, requestHeaders, {
    method: "DELETE"
  })).then(() => void 0),
  completeAllTasks: tasks => fetch(_config.MAIN_URL, _objectSpread({}, requestHeaders, {
    method: "PUT",
...
Header.propTypes = {
  setFilterValue: _propTypes.default.func.isRequired
};
var _default = Header;
exports.default = _default;
...
class TasksList extends _react.default.PureComponent {
  render() {
    const {
      editTaskMessage,
      markAsCompleted,
    ...
    return _react.default.createElement("div", null, _react.default.createElement("ul", null, this.props.tasks.map(task => _react.default.createElement(_Task.default, _extends({
      key: task.id
    }, task, {
...
TasksList.propTypes = {
  tasks: _propTypes.default.arrayOf(_propTypes.default.shape(_task.default)).isRequired,
  editTaskMessage: _propTypes.default.func.isRequired
};
...
class TaskCreator extends _react.default.Component {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "defaultMessage", "");

    _defineProperty(this, "_handleClick", event => {
...
TaskCreator.propTypes = {
  addTask: _propTypes.default.func.isRequired
};
var _default = TaskCreator;
exports.default = _default;
...
Footer.propTypes = {
  isAllTasksCompleted: _propTypes.default.bool.isRequired,
  markAllTasksAsCompleted: _propTypes.default.func.isRequired
};
var _default = Footer;
exports.default = _default;
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.399bd.js.map