...
export default class Scheduler extends Component {
    ...
    componentDidMount () {
        ...
        api.fetchTasks().then((tasks) => this._updateAfterApiCall(tasks));
    }
    ...
    _addTask = (message = "") => {
        ...
        api.createTask(message).then((task) =>
            this._updateAfterApiCall([task, ...tasks])
        );
    };
    ...
    _modifyTask = (id, field, value) => {
        ...
        this.setState({ fetching: true });
        api.updateTask({ ...task, [field]: value }).then(([updatedTask]) =>
            this._updateAfterApiCall(
    ...
    _isAllTasksCompleted = () =>
        !this.state.tasks.find((task) => !task.completed);
        ...
        return (
            <section className = { Styles.scheduler }>
                <main>
                    ...
                    <Header setFilterValue = { this._setFilterValue } />
                    <section>
